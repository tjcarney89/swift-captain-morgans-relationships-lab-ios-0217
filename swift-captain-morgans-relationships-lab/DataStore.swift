...
class DataStore {
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "swift_captain_morgans_relationships_lab", withExtension: "momd")!
    ...
    func fetchData() {
        ...
        do {
            pirates = try managedObjectContext.fetch(pirateRequest)
        }
    ...
    func generateTestData() {
        ...
        for pirateNumber in 0..<numberOfShips.count {
            let currentPirate = NSEntityDescription.insertNewObject(forEntityName: "Pirate", into: managedObjectContext) as! Pirate
            currentPirate.name = "AAARGH! Pirate #" + String(pirateNumber + 1)
            
            for shipNumber in 0..<numberOfShips[pirateNumber] {
                let currentShip = NSEntityDescription.insertNewObject(forEntityName: "Ship", into: managedObjectContext) as! Ship
                currentShip.name = "Awesome Ship #" + String(shipNumber + 1)
                currentShip.engine = NSEntityDescription.insertNewObject(forEntityName: "Engine", into: managedObjectContext) as! Engine
